...
.. _error-code-list-merged:

List of All Error Codes
=======================

This section documents all error codes mypy can generate. Each entry indicates whether the check is enabled by default.
...
------------------------------------------
**Default enabled:** No (requires ``--disallow-any-generics``)
...
------------------------------------------------------------
**Default enabled:** No (requires ``--disallow-untyped-defs``)
...
-------------------------------------------------
**Default enabled:** No (requires ``--warn-redundant-casts``)
...
--------------------------------------------------------------------------
**Default enabled:** No (requires ``--enable-error-code=redundant-self``)
...
-----------------------------------------------------------
**Default enabled:** No (requires ``--strict-equality``)
...
------------------------------------------------------------
**Default enabled:** No (requires ``--disallow-untyped-calls``)
...
-------------------------------------------------------------
**Default enabled:** No (requires ``--warn-return-any``)
...
----------------------------------------------------------------------------------
**Default enabled:** No (requires ``--disallow-any-unimported``)
...
---------------------------------------------------------------
**Default enabled:** No (requires ``--warn-unreachable``)
...
--------------------------------------------------------------
**Default enabled:** No (requires ``--enable-error-code=deprecated``)
...
---------------------------------------------------
**Default enabled:** No (requires ``--enable-error-code=redundant-expr``)
...
---------------------------------------------------------------------------------------
**Default enabled:** No (requires ``--enable-error-code=possibly-undefined``)
...
-----------------------------------------------------------------------------
**Default enabled:** No (requires ``--enable-error-code=truthy-bool``)
...
-------------------------------------------------------------------------------
**Default enabled:** No (requires ``--enable-error-code=truthy-iterable``)
...
.. code-block:: python
    ...
    def transform(items: Iterable[int]) -> list[int]:
        # Error: "items" has type "Iteredable[int]" which can always be true in boolean context. Consider using "Collection[int]" instead.  [truthy-iterable]
        if not items:
            return [42]
...
-------------------------------------------------------------------------
**Default enabled:** No (requires ``--enable-error-code=ignore-without-code``)
...
------------------------------------------------------------
**Default enabled:** No (requires ``--enable-error-code=unused-awaitable``)
...
-------------------------------------------------------------
**Default enabled:** No (requires ``--warn-unused-ignores`` or ``--enable-error-code=unused-ignore``)
...
----------------------------------------------------------------------------------------
**Default enabled:** No (requires ``--enable-error-code=explicit-override``)
...
----------------------------------------------------------------------
**Default enabled:** No (requires ``--enable-error-code=mutable-override``)
...
-------------------------------------------------------------------------------------------
**Default enabled:** No (requires ``--enable-error-code=unimported-reveal``)
...
-----------------------------------------------------------------------
**Default enabled:** No (requires ``--disallow-any-explicit``)
...
-----------------------------------------------------------------------
**Default enabled:** No (requires ``--enable-error-code=exhaustive-match``)
...
--------------------------------------------------------------------------------------------
**Default enabled:** No (requires ``--disallow-untyped-decorators``)
