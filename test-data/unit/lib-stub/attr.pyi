...
@overload
def attr(default: _T = ..., validator: Any = ..., init: bool = ..., convert: Optional[Callable[[Any], _T]] = ..., type: Optional[Callable[..., _T]] = ...) -> _T: ...
@overload
def attr(default: None = ..., validator: None = ..., init: bool = ..., convert: None = ..., type: None = ...) -> Any: ...
