...
@overload
def attr(default: _T = ..., validator: Any = ..., convert: Optional[Callable[[Any], _T]] = ..., type: Optional[Callable[..., _T]] = ...) -> _T: ...
@overload
def attr(default: None = ..., validator: None = ..., convert: None = ..., type: None = ...) -> Any: ...
