...
class _TypedDict(Mapping[str, object]):
    ...
    # Approximate return type (the real one is dict_items); a plugin hook
    # makes the value type precise for TypedDicts with closed=True or
    # extra_items= set (PEP 728).
    def items(self) -> _ItemsView[str, object]: ...

# Approximation of dict_items, to give the return type of _TypedDict.items
# the same shape as in typeshed.
class _ItemsView(Iterable[T_co], Generic[T, T_co]): ...
