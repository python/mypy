...
from mypyc.ir.rtypes import none_rprimitive, str_rprimitive, int32_rprimitive, int64_rprimitive, RType, RUnion, bytes_rprimitive, RInstance, object_rprimitive
...
class TestIrcheck(unittest.TestCase):
    ...
    def test_invalid_return_type(self) -> None:
        ...
        assert_has_error(fn, FnError(source=ret, desc="Cannot coerce source type int32 to dest type int64"))
    ...
    def test_invalid_assign(self) -> None:
        ...
        assert_has_error(fn, FnError(source=assign, desc="Cannot coerce source type int32 to dest type int64"))
