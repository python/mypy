...
class filter(Iterator[T], Generic[T]):
    @overload
    def __init__(self, __function: None, __iterable: Iterable[Optional[T]]) -> None: ...
    @overload
    def __init__(self, __function: Callable[[T], Any], __iterable: Iterable[T]) -> None: ...
...
def exit() -> None: ...
def sum(__iterable: Iterable[T]) -> Union[T, int]: ...
