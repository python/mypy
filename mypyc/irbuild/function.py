...
def gen_func_item(
    ...
    # variables. Generators also temporarily retain the existing environment topology when they
    # are nested or their generated classes can participate in inheritance.
