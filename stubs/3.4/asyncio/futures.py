...
class Future(Iterator[T], Generic[T]):  # (Iterable[T], Generic[T])
    _state = ''
    ...
    def add_done_callback(self, fn: Function[[Future[T]],Any]) -> None: pass
    def remove_done_callback(self, fn: Function[[Future[T]], Any]) -> int: pass
