...
Iterator<t> dropwhile<t>(func<t, any> predicate, Iterable<t> iterable): pass
Iterator<t> filterfalse<t>(func<t, any> predicate, Iterable<t> iterable): pass
Iterator<tuple<t, Iterator<t>>> \
                  groupby<t>(Iterable<t> iterable): pass
Iterator<tuple<s, Iterator<t>>> \
                  groupby<t, s>(Iterable<t> iterable, func<t, s> key): pass
...
Iterator<t> takewhile<t>(func<t, any> predicate, Iterable<t> iterable): pass
