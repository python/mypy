...
def getuid() -> int: ...
def getenv(varname: str, value: Union[str, None] = None) -> str: ...
...
def popen(command: str, *args, **kwargs) -> Union[IO[Any], None]: ...
def tmpfile() -> IO[Any]: ...
...
def utime(path: str, times: Union[None, Tuple[int, int]]) -> None: ...
...
def waitpid(pid: int, options: int) -> int:
    raise OSError()
# TODO: wait3, wait4, W...
def confstr(name: Union[str, int]) -> Union[None, str]: ...
