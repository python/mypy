...
class str(Sequence[str]):
    ...
    def decode(self, encoding: unicode = 'utf-8', errors: unicode = 'strict') -> unicode: ...
    def encode(self, encoding: unicode = 'utf-8', errors: unicode = 'strict') -> str: ...
    def endswith(self, suffix: Union[unicode, bytearray, Tuple[unicode, ...]]) -> bool: ...
    ...
    def startswith(self, prefix: Union[unicode, bytearray, Tuple[unicode, ...]]) -> bool: ...
    @overload
...
class bytearray(Sequence[int]):
    ...
    def endswith(self, suffix: Union[str, bytearray, Tuple[str, ...]]) -> bool: ...
    ...
    def startswith(self, prefix: Union[str, bytearray, Tuple[str, ...]]) -> bool: ...
    @overload
