...
def find(domain: str, localedir: str = None, languages: List[str] = None, all: Any = None) -> Optional[Union[str, List[str]]]: ...

def translation(domain: str, localedir: str = None, languages: List[str] = None, class_: Any = None, fallback: Any = None, codeset: Any = None) -> Translations: ...
def install(domain: str, localedir: str = None, unicode: Any = None, codeset: Any = None, names: Any = None): ...
