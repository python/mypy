...
# TODO buffer type
def unpack(fmt: str, buffer: Any) -> Sequence[object]: ...
def unpack_from(fmt: str, buffer: Any, offset: int = ...) -> Sequence[object]: ...
...
class Struct:
    ...
    def unpack(self, buffer: Any) -> Sequence[object]: ...
    def unpack_from(self, buffer: Any, offset: int = ...) -> Sequence[object]: ...
