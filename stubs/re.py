...
class regex:
    ...
    ???iterator_yielding_match_objects finditer(self, str string, int pos=0, int endpos=-1): pass
    ...
    tuple<str, int> subn(self, func<Match, str> repl, str string, int count=0): pass
...
???iterator_yielding_match_objects finditer(str pattern, str string, int flags=0): pass
