...
class Action(_AttributeHolder):
    ...
    def __init__(self, option_strings, dest, nargs=None, const=None, default=None, type=None, choices=None, required=False, help=None, metavar=None): pass
...
class _StoreConstAction(Action):
    def __init__(self, option_strings, dest, const, default=None, required=False, help=None, metavar=None): pass
    def __call__(self, parser, namespace, values, option_string=None): pass
...
class _VersionAction(Action):
    ...
    def __init__(self, option_strings, version=None, dest=Undefined, default=Undefined, help=''): pass
    def __call__(self, parser, namespace, values, option_string=None): pass

class _SubParsersAction(Action):
class _ChoicesPseudoAction(Action):
        def __init__(self, name, aliases, help): pass
    def __init__(self, option_strings, prog, parser_class, dest=Undefined, help=None, metavar=None): pass
...
class ArgumentParser(_AttributeHolder, _ActionsContainer):
    ...
    def __init__(self, prog=None, usage=None, description=None, epilog=None, parents=Undefined, formatter_class=Undefined, prefix_chars='', fromfile_prefix_chars=None, argument_default=None, conflict_handler='', add_help=True): pass
