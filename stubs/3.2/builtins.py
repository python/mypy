...
class int(SupportsInt, SupportsFloat):
    ...
    def __init__(self, x: Union[SupportsInt, str, _byte_types]=None, base: int=None) -> None:
        pass
...
class float(SupportsFloat, SupportsInt):
    ...
    def __init__(self, x: Union[SupportsFloat, str, _byte_types]=None) -> None:
        pass
...
class bytes(Sequence[int]):
    ...
    def center(self, width: int, fillchar: _byte_types=None) -> bytes:
        pass

    def count(self, x: _byte_types) -> int:
        pass
    ...
    def endswith(self, suffix: _byte_types) -> bool:
        pass

    def expandtabs(self, tabsize: int=8) -> bytes:
        pass

    def find(self, sub: _byte_types, start: int=0, end: int=0) -> int:
        pass

    def index(self, sub: _byte_types, start: int=0, end: int=0) -> int:
        pass
    ...
    def join(self, iterable: Iterable[_byte_types]) -> bytes:
        pass

    def ljust(self, width: int, fillchar: _byte_types=None) -> bytes:
        pass

    def lower(self) -> bytes:
        pass

    def lstrip(self, chars: _byte_types=None) -> bytes:
        pass

    def partition(self, sep: _byte_types) -> Tuple[bytes, bytes, bytes]:
        pass

    def replace(self, old: _byte_types, new: _byte_types, count: int=-1) -> bytes:
        pass

    def rfind(self, sub: _byte_types, start: int=0, end: int=0) -> int:
        pass

    def rindex(self, sub: _byte_types, start: int=0, end: int=0) -> int:
        pass

    def rjust(self, width: int, fillchar: _byte_types=None) -> bytes:
        pass

    def rpartition(self, sep: _byte_types) -> Tuple[bytes, bytes, bytes]:
        pass

    def rsplit(self, sep: _byte_types=None,
               maxsplit: int=-1) -> List[bytes]:
                   pass

    def rstrip(self, chars: _byte_types=None) -> bytes:
        pass

    def split(self, sep: _byte_types=None, maxsplit: int=-1) -> List[bytes]:
        pass

    def splitlines(self, keepends: bool=False) -> List[bytes]:
        pass

    def startswith(self, prefix: _byte_types) -> bool:
        pass

    def strip(self, chars: _byte_types=None) -> bytes:
        pass
    ...
    def translate(self, table: _byte_types) -> bytes:
        pass
    ...
    def __add__(self, s: _byte_types) -> bytes:
        pass
...
class bytearray(Sequence[int]):
    ...
    def center(self, width: int, fillchar: _byte_types=None) -> bytearray:
        pass
    ...
    def join(self, iterable: Iterable[_byte_types]) -> bytearray:
        pass

    def ljust(self, width: int, fillchar: _byte_types=None) -> bytearray:
        pass

    def lower(self) -> bytearray:
        pass

    def lstrip(self, chars: _byte_types=None) -> bytearray:
        pass
    ...
    def rjust(self, width: int, fillchar: _byte_types=None) -> bytearray:
        pass
    ...
    def rsplit(self, sep: _byte_types=None,
               maxsplit: int=-1) -> List[bytearray]:
                   pass

    def rstrip(self, chars: _byte_types=None) -> bytearray:
        pass
    ...
    def strip(self, chars: _byte_types=None) -> bytearray:
        pass
    ...
    def translate(self, table: _byte_types) -> bytearray:
        pass
    ...
    def __add__(self, s: _byte_types) -> bytearray:
        pass

    def __iadd__(self, s: _byte_types) -> bytearray:
        pass
    ...
    def __lt__(self, x: _byte_types) -> bool:
        pass

    def __le__(self, x: _byte_types) -> bool:
        pass

    def __gt__(self, x: _byte_types) -> bool:
        pass

    def __ge__(self, x: _byte_types) -> bool:
        pass
...
class list(Sequence[T], Reversible[T], AbstractGeneric[T]):
    ...
    def index(self, object: T, start: int=0, stop: int=Undefined(int)) -> int:
        pass
    ...
    @overload
    def __setitem__(self, s: slice, o: Sequence[T]) -> None:
        pass
...
class dict(Mapping[KT, VT], Generic[KT, VT]):
    ...
    @overload
    def __init__(self, map: Mapping[KT, VT]) -> None:
        pass
    ...
    def get(self, k: KT, default: VT=None) -> VT:
        pass

    def pop(self, k: KT, default: VT=None) -> VT:
        pass
    ...
    def values(self) -> Set[VT]:
        pass

    def items(self) -> Set[Tuple[KT, VT]]:
        pass

    # TODO: Actually a class method.
    @staticmethod
    @overload
    def fromkeys(seq: Sequence[T]) -> Dict[T, Any]:
        pass

    @staticmethod
    @overload
    def fromkeys(seq: Sequence[T], value: S) -> Dict[T, S]:
        pass
...
class set(AbstractSet[T], Generic[T]):
    ...
    def __or__(self, s: AbstractSet[T]) -> set[T]:
        pass

    def __ior__(self, s: AbstractSet[T]) -> set[T]:
        pass
    ...
    def __xor__(self, s: AbstractSet[T]) -> set[T]:
        pass

    def __ixor__(self, s: AbstractSet[T]) -> set[T]:
        pass
...
class frozenset(AbstractSet[T], Generic[T]):
    ...
    def difference(self, s: AbstractSet[Any]) -> frozenset[T]:
        pass

    def intersection(self, s: AbstractSet[Any]) -> frozenset[T]:
        pass

    def isdisjoint(self, s: AbstractSet[T]) -> bool:
        pass
    ...
    def symmetric_difference(self, s: AbstractSet[T]) -> frozenset[T]:
        pass

    def union(self, s: AbstractSet[T]) -> frozenset[T]:
        pass
    ...
    def __and__(self, s: AbstractSet[T]) -> frozenset[T]:
        pass

    def __or__(self, s: AbstractSet[T]) -> frozenset[T]:
        pass

    def __sub__(self, s: AbstractSet[T]) -> frozenset[T]:
        pass

    def __xor__(self, s: AbstractSet[T]) -> frozenset[T]:
        pass
...
def eval(source: str, globals: Dict[str, Any]=None,
         locals: Mapping[str, Any]=None) -> Any:
             pass
...
@overload
def iter(iterable: Iterable[T]) -> Iterator[T]:
    pass


@overload
def iter(function: Function[[], T], sentinel: T) -> Iterator[T]:
    pass


def isinstance(o: object, t: Union[type, tuple]) -> bool:
    pass
...
@overload
def map(func: Function[[T1], S], iter1: Iterable[T1]) -> Iterator[S]:
    pass
...
@overload
def max(iterable: Iterable[T]) -> T:
    pass


@overload
def max(arg1: T, arg2: T, *args: T) -> T:
    pass
...
@overload
def min(iterable: Iterable[T]) -> T:
    pass


@overload
def min(arg1: T, arg2: T, *args: T) -> T:
    pass
...
@overload
def reversed(object: Reversible[T]) -> Iterator[T]:
    pass
...
@overload
def round(number: SupportsRound[T]) -> T:
    pass


@overload
def round(number: SupportsRound[T], ndigits: int) -> T:
    pass
...
@overload
def zip(iter1: Iterable[T1]) -> Iterator[Tuple[T1]]:
    pass


@overload
def zip(iter1: Iterable[T1],
        iter2: Iterable[T2]) -> Iterator[Tuple[T1, T2]]:
            pass


@overload
def zip(iter1: Iterable[T1], iter2: Iterable[T2],
        iter3: Iterable[T3]) -> Iterator[Tuple[T1, T2, T3]]:
            pass


@overload
def zip(iter1: Iterable[T1], iter2: Iterable[T2], iter3: Iterable[T3],
        iter4: Iterable[T4]) -> Iterator[Tuple[T1, T2, T3, T4]]:
            pass
