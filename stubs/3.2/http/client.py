...
class HTTPSConnection(HTTPConnection):
    ...
    def __init__(self, host, port=None, key_file=None, cert_file=None, timeout=Undefined, source_address=None, *, context=None, check_hostname=None): pass
    sock = Undefined(Any)
    def connect(self): pass
