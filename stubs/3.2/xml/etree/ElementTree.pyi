...
def SubElement(parent, tag, attrib=..., **extra): pass
...
class XMLParser:
    ...
    entity = ... # type: Any
    version = ... # type: Any
    def __init__(self, html=..., target=..., encoding=...): pass
