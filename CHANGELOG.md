 ...
 * Merge commit '9e45dadcf6d8dbab36f83d9df94a706c0b4f9207' into release-1.16 (Jukka Lehtosalo)
 ...
 * Empty commit to trigger wheel builds (Jukka Lehtosalo)
 ...
 * Add the capacity to run individual tests and test files to runtests.py (wyattscarpenter, PR [19069](https://github.com/python/mypy/pull/19069))
 ...
 * fix (Jared Hance)
 * Revert "Update project metadata for PEP 639 (#18821)" (Valentin Stanciu, PR [19052](https://github.com/python/mypy/pull/19052))
 ...
 * [mypyc] Add internal import for _PyUnicode_CheckConsistency for py 3.13 (Valentin Stanciu, PR [19045](https://github.com/python/mypy/pull/19045))
 * [mypyc] Show the reason why a class can't be a native class (Valentin Stanciu, PR [19016](https://github.com/python/mypy/pull/19016))
 ...
 * Add a few more tests for mypyc_attr native_class (dunder methods and metaclasses) (Valentin Stanciu, PR [18999](https://github.com/python/mypy/pull/18999))
 * [mypyc] Refactor IR building for generator functions (Jukka Lehtosalo, PR [19008](https://github.com/python/mypy/pull/19008))
 ...
 * [mypyc] Add more comments about overlapping error values (Jukka Lehtosalo, PR [18963](https://github.com/python/mypy/pull/18963))
 * [mypyc] Fix spilling values with overlapping error values (Jukka Lehtosalo, PR [18961](https://github.com/python/mypy/pull/18961))
 * [mypyc] Fix reference count of spilled register in async def (Jukka Lehtosalo, PR [18957](https://github.com/python/mypy/pull/18957))
 * [mypyc] Add some async tests (Jukka Lehtosalo, PR [18956](https://github.com/python/mypy/pull/18956))
 * [mypyc] Add hidden flag to skip the generation of C files (Jukka Lehtosalo, PR [18955](https://github.com/python/mypy/pull/18955))
 * Update math error messages for 3.14 (2) (Marc Mueller, PR [18949](https://github.com/python/mypy/pull/18949))
 * [mypyc] Support yields while values are live (Michael J. Sullivan, PR [16305](https://github.com/python/mypy/pull/16305))
 ...
 * [mypyc] Using UnboundedType to access class object of a type annotation (Advait Dixit, PR [18874](https://github.com/python/mypy/pull/18874))
 ...
 * [mypyc] Add basic optimization for sorted (Marc Mueller, PR [18902](https://github.com/python/mypy/pull/18902))
 ...
 * [mypyc] Optimize list.__imul__, tuple.__mul__ (Marc Mueller, PR [18887](https://github.com/python/mypy/pull/18887))
 ...
 * Add shared checker interface to break import cycle (Ivan Levkivskyi, PR [18878](https://github.com/python/mypy/pull/18878))
 * Use checkmember.py to check multiple inheritance (Ivan Levkivskyi, PR [18876](https://github.com/python/mypy/pull/18876))
 * Enable FURB187 - avoid reverse list copy (Aaron Gokaslan, PR [18716](https://github.com/python/mypy/pull/18716))
 ...
 * Add setup.py to selfcheck (Michael R. Crusoe, PR [18609](https://github.com/python/mypy/pull/18609))
 ...
 * [mypyc] Optimize list.__add__, list.__iadd__, tuple.__add__ (Marc Mueller, PR [18845](https://github.com/python/mypy/pull/18845))
 * Use checkmember.py to check variable overrides (Ivan Levkivskyi, PR [18847](https://github.com/python/mypy/pull/18847))
 * nit: Fix wrong example code in comment (Tim Ruffing, PR [18860](https://github.com/python/mypy/pull/18860))
 * Fix crash on multiple unpacks in a bare type application (Stanislav Terliakov, PR [18857](https://github.com/python/mypy/pull/18857))
 ...
 * [mypyc] Various improvements to annotated html generation (Jukka Lehtosalo, PR [18848](https://github.com/python/mypy/pull/18848))
 * Update project metadata for PEP 639 (Marc Mueller, PR [18821](https://github.com/python/mypy/pull/18821))
 * Enable ruff FURB None rules (Aaron Gokaslan, PR [18687](https://github.com/python/mypy/pull/18687))
 * [mypyc] Support for annotating classes to be native or not (native_class=True/False) (Valentin Stanciu, PR [18802](https://github.com/python/mypy/pull/18802))
 * [mypyc] Optimize builtins.repr (Marc Mueller, PR [18844](https://github.com/python/mypy/pull/18844))
 * [mypyc] Detect more issues when generating annotated HTML (Jukka Lehtosalo, PR [18838](https://github.com/python/mypy/pull/18838))
 ...
 * Consolidate descriptor handling in checkmember.py (Ivan Levkivskyi, PR [18831](https://github.com/python/mypy/pull/18831))
 * [mypyc] Display IR on annotate test failure (Jukka Lehtosalo, PR [18835](https://github.com/python/mypy/pull/18835))
 * [mypyc] Allow specifying annotate test case outputs using comments (Jukka Lehtosalo, PR [18834](https://github.com/python/mypy/pull/18834))
 * [mypyc] Add prototype feature to generate annotated html of compiled code (Jukka Lehtosalo, PR [18828](https://github.com/python/mypy/pull/18828))
 * Move one more function from checkmember.py (Ivan Levkivskyi, PR [18825](https://github.com/python/mypy/pull/18825))
 * Remove last occurrences of Python 2.7 (Dimitri Papadopoulos Orfanos, PR [18822](https://github.com/python/mypy/pull/18822))
 * Move some functions from checkmember to typeops (Ivan Levkivskyi, PR [18820](https://github.com/python/mypy/pull/18820))
 * Do not pass message builder to analyze_member_access (Ivan Levkivskyi, PR [18818](https://github.com/python/mypy/pull/18818))
 * stubtest: understand override (Shantanu, PR [18815](https://github.com/python/mypy/pull/18815))
 * Inline a trivial function in checkmember.py (Ivan Levkivskyi, PR [18819](https://github.com/python/mypy/pull/18819))
 * Add flag to allow more flexible variable redefinition (Jukka Lehtosalo, PR [18727](https://github.com/python/mypy/pull/18727))
 * [mypyc] Add and implement primitive list.copy() (exertustfm, PR [18771](https://github.com/python/mypy/pull/18771))
 ...
 * [mypyc] Support iterating over keys/values/items of dict-bound TypeVar and ParamSpec.kwargs (Stanislav Terliakov, PR [18789](https://github.com/python/mypy/pull/18789))
 * [mypyc] Document that strip() etc. are optimized (Jukka Lehtosalo, PR [18793](https://github.com/python/mypy/pull/18793))
 * Fix crash on decorated getter in settable property (Ivan Levkivskyi, PR [18787](https://github.com/python/mypy/pull/18787))
 * Update ruff to 0.9.10 (Marc Mueller, PR [18788](https://github.com/python/mypy/pull/18788))
 * Fix crash for callable with *args and suffix against Any (Ivan Levkivskyi, PR [18781](https://github.com/python/mypy/pull/18781))
 * [mypyc] Add efficient primitives for str.strip() etc (Advait Dixit, PR [18742](https://github.com/python/mypy/pull/18742))
 * [mypyc] Replace internal _PyObject_CallMethodId calls (Marc Mueller, PR [18761](https://github.com/python/mypy/pull/18761))
 ...
 * [ci] Switch back to ubuntu-24.04-arm runners (Marc Mueller, PR [18733](https://github.com/python/mypy/pull/18733))
 * [mypyc] Fix order of steal/unborrow in tuple unpacking (Ivan Levkivskyi, PR [18732](https://github.com/python/mypy/pull/18732))
 ...
 * Update CREDITS to correct my name (Emma Smith, PR [18710](https://github.com/python/mypy/pull/18710))
 * [mypyc] Optimize str.find and str.rfind (Marc Mueller, PR [18709](https://github.com/python/mypy/pull/18709))
 * [mypyc] Optimize str.__contains__ (Marc Mueller, PR [18705](https://github.com/python/mypy/pull/18705))
 * Enable ruff SIM101 duplicate isinstance check (Aaron Gokaslan, PR [18679](https://github.com/python/mypy/pull/18679))
 ...
 * [mypyc] Optimize str.partition and str.rpartition (Marc Mueller, PR [18702](https://github.com/python/mypy/pull/18702))
 * [mypyc] Improve str.startswith and str.endswith with tuple argument (Marc Mueller, PR [18703](https://github.com/python/mypy/pull/18703))
 * [mypyc] Optimize str.startswith and str.endswith with tuple argument (Marc Mueller, PR [18678](https://github.com/python/mypy/pull/18678))
 ...
 * [mypyc] Optimize str.splitlines (Marc Mueller, PR [18677](https://github.com/python/mypy/pull/18677))
 * [mypyc] Mark dict.setdefault as optimized (Marc Mueller, PR [18685](https://github.com/python/mypy/pull/18685))
 * [mypyc] Support __del__ methods (Advait Dixit, PR [18519](https://github.com/python/mypy/pull/18519))
 * [ci] Use ubuntu-22.04-arm runners (Marc Mueller, PR [18676](https://github.com/python/mypy/pull/18676))
 * [mypyc] Optimize str.rsplit (Marc Mueller, PR [18673](https://github.com/python/mypy/pull/18673))
 ...
 * Enable ruff FURB188: str.remove(pre|suf)fix (Aaron Gokaslan, PR [18671](https://github.com/python/mypy/pull/18671))
 * [mypyc] Optimize str.removeprefix and str.removesuffix (Marc Mueller, PR [18672](https://github.com/python/mypy/pull/18672))
 * Enable `warn_unreachable` for `mypy` self-check (sobolevn, PR [18523](https://github.com/python/mypy/pull/18523))
 ...
 * Allow lowered opts to be deleted in lowering trasnform (Jukka Lehtosalo, PR [18669](https://github.com/python/mypy/pull/18669))
 ...
 * Add codespell to pre-commit config (Marc Mueller, PR [18645](https://github.com/python/mypy/pull/18645))
 ...
 * Update a few more imports in tests (Marc Mueller, PR [18655](https://github.com/python/mypy/pull/18655))
 * Add initial changelog for 1.16 (Marc Mueller, PR [18652](https://github.com/python/mypy/pull/18652))
 * Remove bogus TODO added in #18585 (Stanislav Terliakov, PR [18603](https://github.com/python/mypy/pull/18603))
 ...
 * Fix spelling (Marc Mueller, PR [18642](https://github.com/python/mypy/pull/18642))
 ...
 * [mypyc] Recognize Literal types in __match_args__ (Stanislav Terliakov, PR [18636](https://github.com/python/mypy/pull/18636))
 ...
 * Include fullname in Var repr (Jukka Lehtosalo, PR [18632](https://github.com/python/mypy/pull/18632))
 * Fix crashes on incorectly detected recursive aliases (Ivan Levkivskyi, PR [18625](https://github.com/python/mypy/pull/18625))
 * Add missing test case for polymorphic inference (Ivan Levkivskyi, PR [18626](https://github.com/python/mypy/pull/18626))
 ...
 * Update comments and docstrings related to binder (Jukka Lehtosalo, PR [18611](https://github.com/python/mypy/pull/18611))
 * [misc] fix blog post generator quirks (Wesley Collin Wright, PR [18601](https://github.com/python/mypy/pull/18601))
 ...
 * [misc] automatically strip periods when generating changelog entries (Wesley Collin Wright, PR [18598](https://github.com/python/mypy/pull/18598))
 ...
 * Fix markup in CHANGELOG for mypy@1.15 (sobolevn, PR [18607](https://github.com/python/mypy/pull/18607))
 ...
 * [mypyc] Handle non extention classes with attribute annotations for forward defined classes (Valentin Stanciu, PR [18577](https://github.com/python/mypy/pull/18577))
 * Remove support for `builtins.Any` (Marc Mueller, PR [18578](https://github.com/python/mypy/pull/18578))
 * [mypyc] Use lower-case generic types such as "list[t]" in docs (Jukka Lehtosalo, PR [18576](https://github.com/python/mypy/pull/18576))
 * [mypyc] Improve support for frozenset (Marc Mueller, PR [18571](https://github.com/python/mypy/pull/18571))
 * Cleanup backwards compat layer for use_vectorcall and use_method_vectorcall (Marc Mueller, PR [18548](https://github.com/python/mypy/pull/18548))
 * Remove old TypedDict + NamedTuple code from mypyc (Marc Mueller, PR [18554](https://github.com/python/mypy/pull/18554))
 ...
 * Update black to 25.1.0 (Marc Mueller, PR [18570](https://github.com/python/mypy/pull/18570))
 * Update lxml test requirement to 5.3.0 (Marc Mueller, PR [18558](https://github.com/python/mypy/pull/18558))
 * [mypyc] Fix wheel build for cp313-win (Marc Mueller, PR [18560](https://github.com/python/mypy/pull/18560))
 * [mypyc] Add debug op (and builder helper) for printing str or Value (Valentin Stanciu, PR [18552](https://github.com/python/mypy/pull/18552))
 *  PEP 702 (@deprecated): "normal" overloaded methods (Christoph Tyralla, PR [18477](https://github.com/python/mypy/pull/18477))
 * Update test requirements (Marc Mueller, PR [18551](https://github.com/python/mypy/pull/18551))
 * Remove old marcos for _PyObject_CallMethod. (Marc Mueller, PR [18555](https://github.com/python/mypy/pull/18555))
 ...
 * Update capi_version for mypyc tests to 3.9 (Marc Mueller, PR [18546](https://github.com/python/mypy/pull/18546))
 * Update capi_version for mypyc tests to 3.8 (Marc Mueller, PR [18341](https://github.com/python/mypy/pull/18341))
 ...
 * Run mypy_primer in 3.13 (Shantanu, PR [18542](https://github.com/python/mypy/pull/18542))
 ...
 * Use new Github actions ARM runners for tests (Marc Mueller, PR [18483](https://github.com/python/mypy/pull/18483))
 ...
 * pytest options moved into pyproject.toml (Michael R. Crusoe, PR [18501](https://github.com/python/mypy/pull/18501))
 ...
 * [mypyc] Reduce impact of immortality on reference counting performance (Jukka Lehtosalo, PR [18459](https://github.com/python/mypy/pull/18459))
