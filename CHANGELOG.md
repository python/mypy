...
- Fix crash in `split_for_callable` when passing values to variadic generics (Aaron Wieczorek, PR [20543](https://github.com/python/mypy/pull/20543))
...
- Fix crash in vec `len()` plugin (Jukka Lehtosalo, PR [20774](https://github.com/python/mypy/pull/20774))
...
- Do not preemptively diff and union op level dataflow sets (Vaggelis Danias, PR [20897](https://github.com/python/mypy/pull/20897))
...
- Add float read/write functions to `librt.strings` (Jukka Lehtosalo, PR [20778](https://github.com/python/mypy/pull/20778))
- Add big endian read/write functions to `librt.strings` (Jukka Lehtosalo, PR [20772](https://github.com/python/mypy/pull/20772))
- Add `i32` and `i64` read/write functions to `librt.strings` (Jukka Lehtosalo, PR [20757](https://github.com/python/mypy/pull/20757))
- Add `write_i16_le` and `read_i16_le` to `librt.strings` (Jukka Lehtosalo, PR [20745](https://github.com/python/mypy/pull/20745))
- Add codegen support and compiled run tests for vecs (Jukka Lehtosalo, PR [20737](https://github.com/python/mypy/pull/20737))
...
- Extend `get_expr_length` for `enumerate`, `map`, `zip`, `range`, `list`, `tuple`, `sorted`, and `reversed` (BobTheBuidler, PR [19927](https://github.com/python/mypy/pull/19927))
- Raise `ValueError` if int too big for native int type (Jukka Lehtosalo, PR [20385](https://github.com/python/mypy/pull/20385))
- Speed up BytesWriter `append`, `write` and `len` operations (Jukka Lehtosalo, PR [20380](https://github.com/python/mypy/pull/20380))
- Fix generator regression with empty tuple (BobTheBuidler, PR [20371](https://github.com/python/mypy/pull/20371))
- Use `get_expr_length_value` in `translate_len` (BobTheBuidler, PR [20074](https://github.com/python/mypy/pull/20074))
...
- Extend `get_expr_length` to try `constant_fold_expr` (BobTheBuidler, PR [19930](https://github.com/python/mypy/pull/19930))
- Fix compilation of byteswriter extra ops (Piotr Sawicki, PR [20403](https://github.com/python/mypy/pull/20403))
...
- Add get/set item, len and truncate to BytesWriter (Jukka Lehtosalo, PR [20298](https://github.com/python/mypy/pull/20298))
- Add minimal BytesWriter class to librt (Jukka Lehtosalo, PR [20297](https://github.com/python/mypy/pull/20297))
...
- Do not report trivial narrowing as a change in binder (Ivan Levkivskyi, PR [20862](https://github.com/python/mypy/pull/20862))
- Delete fast container literal cache (Ivan Levkivskyi, PR [20875](https://github.com/python/mypy/pull/20875))
- Fix incorrect fast path in `is_same_type()` (Ivan Levkivskyi, PR [20874](https://github.com/python/mypy/pull/20874))
- Unify empty context fallback in assignments (Ivan Levkivskyi, PR [20851](https://github.com/python/mypy/pull/20851))
...
- Correct `check_default_args()` and related error messages (Kai (Kazuya Ito), PR [20964](https://github.com/python/mypy/pull/20964))
...
- Fix synced itertools (Piotr Sawicki, PR [20700](https://github.com/python/mypy/pull/20700))
- Fix enum value inference with user-defined data type mixin (E. M. Bray, PR [16320](https://github.com/python/mypy/pull/16320))
- Sync enum members logic in `typeanal` and `checkmember` (Stanislav Terliakov, PR [19687](https://github.com/python/mypy/pull/19687))
- Improve `CallableType` join in simple cases (Shantanu, PR [18406](https://github.com/python/mypy/pull/18406))
...
- Comprehensions trigger `is_func_scope()` (A5rocks, PR [20540](https://github.com/python/mypy/pull/20540))
- Fix specialization leak in generic `TypedDict.update()` (Aaron Wieczorek, PR [20517](https://github.com/python/mypy/pull/20517))
- Fix `conditional_types` remainder for structural types (Randolf Scholz, PR [20450](https://github.com/python/mypy/pull/20450))
...
- Fix whether `MemberExpr.expr` represents `self`/`cls` inside methods (bzoracler, PR [20480](https://github.com/python/mypy/pull/20480))
...
- Patch `check_op_reversible` to support tuple subclasses (Randolf Scholz, PR [19046](https://github.com/python/mypy/pull/19046))
- Refactor `visit_conditional_expr` to fix ternary behavior (Randolf Scholz, PR [19563](https://github.com/python/mypy/pull/19563))
...
- Improve `MappingPattern` rest location (Marc Mueller, PR [20407](https://github.com/python/mypy/pull/20407))
...
- Provide a fullname for `__module__` (A5rocks, PR [20288](https://github.com/python/mypy/pull/20288))
