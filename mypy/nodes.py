...
from typing_extensions import DefaultDict, Final, TYPE_CHECKING, TypeAlias
...
Definition: TypeAlias = Tuple[str, 'SymbolTableNode', Optional['TypeInfo']]
...
OverloadPart: TypeAlias = Union['FuncDef', 'Decorator']
