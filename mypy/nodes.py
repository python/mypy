...
class SymbolTableNode:
    ...
    Attributes:
        ...
        fictional_plugin_generated: If it was generated by a plugin,
            does it actually exist at runtime?
            (We generate some fictional methods for e.g. dataclasses; stubtest
            needs to be able to know if they actually exist at runtime or not.)
    ...
    def __init__(
        ...
        *,
        ...
        self.fictional_plugin_generated = fictional_plugin_generated
