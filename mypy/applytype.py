...
def apply_generic_arguments(
    ...
    def get_target_type(tvar: TypeVarDef, type: ProperType) -> Optional[Type]:
    ...
    expanded_callable_type = expand_type(callable, id_to_type)
    # The callable may retain some type vars if only some were applied.
    remaining_tvars = [tv for tv in tvars if tv.id not in id_to_type]
    return expanded_callable_type.copy_modified(variables=remaining_tvars)
