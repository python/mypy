...
INDEX: Final = ErrorCode(
    'index', "Check indexing operations", 'General')
...
DICT_ITEM: Final = ErrorCode(
    'dict-item',
    "Check dict items in a dict expression {key: value, ...}", 'General')
...
COMPARISON_OVERLAP: Final = ErrorCode(
    'comparison-overlap',
    "Check that types in comparisons and 'in' expressions overlap", 'General')
...
SYNTAX: Final = ErrorCode(
    'syntax', "Report syntax errors", 'General')

# This is a catch-all for remaining uncategorized errors.
MISC: Final = ErrorCode(
    'misc', "Miscellaneous other checks", 'General')
