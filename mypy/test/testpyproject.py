"""Test cases for pyproject.toml configs.
...
class PythonPyprojectSuite(DataSuite):
    files = pyproject_files
    native_sep = True

    def run_case(self, testcase: DataDrivenTestCase) -> None:
        for step in [1] + sorted(testcase.output2):
            test_python_pyproject(testcase, step)


def test_python_pyproject(testcase: DataDrivenTestCase, step: int) -> None:
