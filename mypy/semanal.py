...
def contains_int_or_tuple_of_ints(expr: Expression) -> Union[None, int, Tuple[int], Tuple[int, ...]]:
...
def contains_sys_version_info(expr: Expression) -> Union[None, int, Tuple[Optional[int], Optional[int]]]:
