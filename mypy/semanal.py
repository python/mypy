...
class SemanticAnalyzer(NodeVisitor):
    ...
    def clean_up_bases_and_infer_type_variables(self, defn: ClassDef) -> None:
        ...
        for i, base_expr in enumerate(defn.base_type_exprs):
            try:
                ...
                continue
            tvars = self.specialtype.analyze_typevar_declaration(base)
    ...
    def expr_to_analyzed_type(self, expr: Expression) -> Type:
        if isinstance(expr, CallExpr):
            expr.accept(self)
            typ = self.specialtype.analyze_callexpr_as_type(expr)
            if typ is None:
    ...
    def visit_assignment_stmt(self, s: AssignmentStmt) -> None:
        ...
        self.specialtype.process_declaration(s)
