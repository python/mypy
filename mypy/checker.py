...
DeferredNodeType: TypeAlias = Union[FuncDef, LambdaExpr, OverloadedFuncDef, Decorator]
FineGrainedDeferredNodeType: TypeAlias = Union[FuncDef, MypyFile, OverloadedFuncDef]
...
TypeMap: TypeAlias = Optional[Dict[Expression, Type]]
