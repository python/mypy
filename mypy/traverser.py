...
from mypy.nodes import (
    ...
    Expression, PromoteExpr, BreakStmt, BytesExpr, ComplexExpr, ContinueStmt, EllipsisExpr,
    EnumCallExpr, FloatExpr, GlobalDecl, ImportAll, IntExpr, NamedTupleExpr, NewTypeExpr,
    NonlocalDecl, ParamSpecExpr, PassStmt, PlaceholderNode, StrExpr, TempNode, TypeAlias,
    TypeAliasExpr, TypeVarExpr, TypeVarTupleExpr, TypedDictExpr, UnicodeExpr, Var,
)
...
class ExtendedTraverserVisitor(TraverserVisitor):
    ...
    def visit_placeholder_node(self, o: PlaceholderNode) -> None:
        if not self.visit(o):
            return
        super().visit_placeholder_node(o)
