...
def poll(timeout: float | int = 0.0, map: _MapType | None = None) -> None: ...
def poll2(timeout: float | int = 0.0, map: _MapType | None = None) -> None: ...

poll3 = poll2

def loop(timeout: float | int = 30.0, use_poll: bool = False, map: _MapType | None = None, count: int | None = None) -> None: ...
