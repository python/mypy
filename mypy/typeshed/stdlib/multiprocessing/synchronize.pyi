...
class Barrier(threading.Barrier):
    def __init__(
        self, parties: int, action: Callable[[], object] | None = None, timeout: float | int | None = None, *ctx: BaseContext
    ) -> None: ...
...
class Condition(AbstractContextManager[bool, None]):
    ...
    def wait_for(self, predicate: Callable[[], bool], timeout: float | int | None = None) -> bool: ...
    def acquire(self, block: bool = ..., timeout: float | int | None = ...) -> bool: ...
