...
class date:
    ...
    @classmethod
    def fromtimestamp(cls, timestamp: float | int, /) -> Self: ...
    @classmethod
    def today(cls) -> Self: ...
    @classmethod
...
class timedelta:
    ...
    def __mul__(self, value: float | int, /) -> timedelta: ...
    def __rmul__(self, value: float | int, /) -> timedelta: ...
    @overload
    ...
    @overload
    def __truediv__(self, value: float | int, /) -> timedelta: ...
...
class datetime(date):
    ...
    if sys.version_info >= (3, 12):
        @classmethod
        def fromtimestamp(cls, timestamp: float | int, tz: _TzInfo | None = ...) -> Self: ...
    else:
        @classmethod
        def fromtimestamp(cls, timestamp: float | int, /, tz: _TzInfo | None = ...) -> Self: ...
    ...
    def utcfromtimestamp(cls, t: float | int, /) -> Self: ...
    @classmethod
