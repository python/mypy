...
class Telnet:
    ...
    def __init__(self, host: str | None = None, port: int = 0, timeout: float | int = ...) -> None: ...
    def open(self, host: str, port: int = 0, timeout: float | int = ...) -> None: ...
    ...
    def read_until(self, match: bytes, timeout: float | int | None = None) -> bytes: ...
    ...
    def expect(
        self, list: Sequence[Pattern[bytes] | bytes], timeout: float | int | None = None
