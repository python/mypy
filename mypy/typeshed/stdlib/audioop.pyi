...
def mul(fragment: Buffer, width: int, factor: float | int, /) -> bytes: ...
def ratecv(
    fragment: Buffer,
    width: int,
    nchannels: int,
...
def tomono(fragment: Buffer, width: int, lfactor: float | int, rfactor: float | int, /) -> bytes: ...
def tostereo(fragment: Buffer, width: int, lfactor: float | int, rfactor: float | int, /) -> bytes: ...
