...
class NormalDist:
    def __init__(self, mu: float | int = 0.0, sigma: float | int = 1.0) -> None: ...
    @property
    def mean(self) -> float: ...
    @property
    ...
    def inv_cdf(self, p: float | int) -> float: ...
    ...
    def __add__(self, x2: float | int | NormalDist) -> NormalDist: ...
    def __sub__(self, x2: float | int | NormalDist) -> NormalDist: ...
    def __mul__(self, x2: float | int) -> NormalDist: ...
    def __truediv__(self, x2: float | int) -> NormalDist: ...
    def __pos__(self) -> NormalDist: ...
    def __neg__(self) -> NormalDist: ...
    __radd__ = __add__
    def __rsub__(self, x2: float | int | NormalDist) -> NormalDist: ...
    __rmul__ = __mul__
