...
class IMAP4:
    ...
    if sys.version_info >= (3, 9):
        def __init__(self, host: str = "", port: int = 143, timeout: float | int | None = None) -> None: ...
        def open(self, host: str = "", port: int = 143, timeout: float | int | None = None) -> None: ...
    else:
...
class IMAP4_SSL(IMAP4):
    ...
    if sys.version_info >= (3, 12):
        def __init__(
            self, host: str = "", port: int = 993, *, ssl_context: SSLContext | None = None, timeout: float | int | None = None
        ) -> None: ...
    ...
    file: IO[Any]
    if sys.version_info >= (3, 9):
        def open(self, host: str = "", port: int | None = 993, timeout: float | int | None = None) -> None: ...
    else:
...
class IMAP4_stream(IMAP4):
    ...
    readfile: IO[Any]
    if sys.version_info >= (3, 9):
        def open(self, host: str | None = None, port: int | None = None, timeout: float | int | None = None) -> None: ...
    else:
...
def Time2Internaldate(date_time: float | int | time.struct_time | time._TimeTuple | datetime | str) -> str: ...
