...
def ctime(seconds: float | int | None = None, /) -> str: ...
def gmtime(seconds: float | int | None = None, /) -> struct_time: ...
def localtime(seconds: float | int | None = None, /) -> struct_time: ...
...
if sys.platform != "win32":
    ...
    def clock_settime(clk_id: int, time: float | int, /) -> None: ...  # Unix only
