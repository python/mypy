...
class Vec2D(tuple[float, float]):
    def __new__(cls, x: float | int, y: float | int) -> Self: ...
...
class TurtleScreenBase:
    ...
    def numinput(
        self, title: str, prompt: str, default: float | int | None = None, minval: float | int | None = None, maxval: float | int | None = None
    ) -> float | None: ...
...
class TurtleScreen(TurtleScreenBase):
    def __init__(self, cv: Canvas, mode: str = "standard", colormode: float | int = 1.0, delay: int = 10) -> None: ...
    def clear(self) -> None: ...
    @overload
    def mode(self, mode: None = None) -> str: ...
    @overload
    def mode(self, mode: str) -> None: ...
    def setworldcoordinates(self, llx: float | int, lly: float | int, urx: float | int, ury: float | int) -> None: ...
    def register_shape(self, name: str, shape: _PolygonCoords | Shape | None = None) -> None: ...
    @overload
    def colormode(self, cmode: None = None) -> float: ...
    @overload
    def colormode(self, cmode: float | int) -> None: ...
    def reset(self) -> None: ...
    ...
    @overload
    def bgcolor(self, r: float | int, g: float | int, b: float | int) -> None: ...
    @overload
    ...
    def listen(self, xdummy: float | int | None = None, ydummy: float | int | None = None) -> None: ...
...
class TNavigator:
    ...
    def reset(self) -> None: ...
    def degrees(self, fullcircle: float | int = 360.0) -> None: ...
    def radians(self) -> None: ...
    if sys.version_info >= (3, 12):
        def teleport(self, x: float | int | None = None, y: float | int | None = None, *, fill_gap: bool = False) -> None: ...

    def forward(self, distance: float | int) -> None: ...
    def back(self, distance: float | int) -> None: ...
    def right(self, angle: float | int) -> None: ...
    def left(self, angle: float | int) -> None: ...
    def pos(self) -> Vec2D: ...
    def xcor(self) -> float: ...
    def ycor(self) -> float: ...
    @overload
    ...
    @overload
    def goto(self, x: float | int, y: float | int) -> None: ...
    def home(self) -> None: ...
    def setx(self, x: float | int) -> None: ...
    def sety(self, y: float | int) -> None: ...
    @overload
    def distance(self, x: TNavigator | tuple[float, float], y: None = None) -> float: ...
    @overload
    def distance(self, x: float | int, y: float | int) -> float: ...
    @overload
    def towards(self, x: TNavigator | tuple[float, float], y: None = None) -> float: ...
    @overload
    def towards(self, x: float | int, y: float | int) -> float: ...
    def heading(self) -> float: ...
    def setheading(self, to_angle: float | int) -> None: ...
    def circle(self, radius: float | int, extent: float | int | None = None, steps: int | None = None) -> None: ...
    fd = forward
    bk = back
    backward = back
    rt = right
...
class TPen:
    ...
    @overload
    def pencolor(self, r: float | int, g: float | int, b: float | int) -> None: ...
    @overload
    def fillcolor(self) -> _AnyColor: ...
    @overload
    def fillcolor(self, color: _Color) -> None: ...
    @overload
    def fillcolor(self, r: float | int, g: float | int, b: float | int) -> None: ...
    @overload
    def color(self) -> tuple[_AnyColor, _AnyColor]: ...
    @overload
    def color(self, color: _Color) -> None: ...
    @overload
    def color(self, r: float | int, g: float | int, b: float | int) -> None: ...
    @overload
...
class RawTurtle(TPen, TNavigator):
    ...
    @overload
    def shapesize(
        self, stretch_wid: float | int | None = None, stretch_len: float | int | None = None, outline: float | int | None = None
    ) -> None: ...
    @overload
    def shearfactor(self, shear: None = None) -> float: ...
    @overload
    def shearfactor(self, shear: float | int) -> None: ...
    # Unsafely overlaps when no arguments are provided
    @overload
    def shapetransform(self) -> tuple[float, float, float, float]: ...  # type: ignore[overload-overlap]
    @overload
    def shapetransform(
        self, t11: float | int | None = None, t12: float | int | None = None, t21: float | int | None = None, t22: float | int | None = None
    ) -> None: ...
    def get_shapepoly(self) -> _PolygonCoords | None: ...
    def settiltangle(self, angle: float | int) -> None: ...
    @overload
    def tiltangle(self, angle: None = None) -> float: ...
    @overload
    def tiltangle(self, angle: float | int) -> None: ...
    def tilt(self, angle: float | int) -> None: ...
...
def numinput(
    title: str, prompt: str, default: float | int | None = None, minval: float | int | None = None, maxval: float | int | None = None
) -> float | None: ...
...
def setworldcoordinates(llx: float | int, lly: float | int, urx: float | int, ury: float | int) -> None: ...
def register_shape(name: str, shape: _PolygonCoords | Shape | None = None) -> None: ...
@overload
def colormode(cmode: None = None) -> float: ...
@overload
def colormode(cmode: float | int) -> None: ...
def reset() -> None: ...
...
@overload
def bgcolor(r: float | int, g: float | int, b: float | int) -> None: ...
@overload
...
def listen(xdummy: float | int | None = None, ydummy: float | int | None = None) -> None: ...
...
def setup(width: float | int = 0.5, height: float | int = 0.75, startx: int | None = None, starty: int | None = None) -> None: ...
...
def degrees(fullcircle: float | int = 360.0) -> None: ...
def radians() -> None: ...
def forward(distance: float | int) -> None: ...
def back(distance: float | int) -> None: ...
def right(angle: float | int) -> None: ...
def left(angle: float | int) -> None: ...
def pos() -> Vec2D: ...
def xcor() -> float: ...
def ycor() -> float: ...
@overload
...
@overload
def goto(x: float | int, y: float | int) -> None: ...
def home() -> None: ...
def setx(x: float | int) -> None: ...
def sety(y: float | int) -> None: ...
@overload
def distance(x: TNavigator | tuple[float, float], y: None = None) -> float: ...
@overload
def distance(x: float | int, y: float | int) -> float: ...
@overload
def towards(x: TNavigator | tuple[float, float], y: None = None) -> float: ...
@overload
def towards(x: float | int, y: float | int) -> float: ...
def heading() -> float: ...
def setheading(to_angle: float | int) -> None: ...
def circle(radius: float | int, extent: float | int | None = None, steps: int | None = None) -> None: ...
...
@overload
def pencolor(r: float | int, g: float | int, b: float | int) -> None: ...
@overload
def fillcolor() -> _AnyColor: ...
@overload
def fillcolor(color: _Color) -> None: ...
@overload
def fillcolor(r: float | int, g: float | int, b: float | int) -> None: ...
@overload
def color() -> tuple[_AnyColor, _AnyColor]: ...
@overload
def color(color: _Color) -> None: ...
@overload
def color(r: float | int, g: float | int, b: float | int) -> None: ...
@overload
...
if sys.version_info >= (3, 12):
    def teleport(x: float | int | None = None, y: float | int | None = None, *, fill_gap: bool = False) -> None: ...

# Unsafely overlaps when no arguments are provided
@overload
def shapesize() -> tuple[float, float, float]: ...  # type: ignore[overload-overlap]
@overload
def shapesize(stretch_wid: float | int | None = None, stretch_len: float | int | None = None, outline: float | int | None = None) -> None: ...
@overload
def shearfactor(shear: None = None) -> float: ...
@overload
def shearfactor(shear: float | int) -> None: ...
...
@overload
def shapetransform(
    t11: float | int | None = None, t12: float | int | None = None, t21: float | int | None = None, t22: float | int | None = None
) -> None: ...
def get_shapepoly() -> _PolygonCoords | None: ...
def settiltangle(angle: float | int) -> None: ...
@overload
def tiltangle(angle: None = None) -> float: ...
@overload
def tiltangle(angle: float | int) -> None: ...
def tilt(angle: float | int) -> None: ...
