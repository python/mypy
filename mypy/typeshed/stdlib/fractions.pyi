...
class Fraction(Rational):
    ...
    @overload
    def __new__(cls, value: float | int | Decimal | str, /) -> Self: ...
    @classmethod
    def from_float(cls, f: float | int) -> Self: ...
    @classmethod
