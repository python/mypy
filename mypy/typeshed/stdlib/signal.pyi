...
if sys.platform == "win32":
    ...
    def setitimer(which: int, seconds: float | int, interval: float | int = 0.0, /) -> tuple[float, float]: ...
    ...
    if sys.platform != "darwin":
        ...
        def sigtimedwait(sigset: Iterable[int], timeout: float | int, /) -> struct_siginfo | None: ...
