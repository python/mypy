...
def generate_stub(path, output_dir, _all_=None, quiet=False, target=None, add_header=False,
                  module=None):
...
def generate_stub_for_module(module, output_dir, quiet=False, add_header=False):
    ...
    generate_stub(mod.__file__, output_dir, getattr(mod, '__all__', None), quiet, target=target,
                  add_header=add_header, module=module)
...
if __name__ == '__main__':
    ...
    for module in sys.argv[1:]:
        generate_stub_for_module(module, 'out', add_header=True)
