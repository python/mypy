...
class ParserSuite(Suite):
    def cases(self):
        ...
        return parse_test_cases(os.path.join(test_data_prefix, 'parse.test'), test_parser)
...
def test_parser(testcase):
    ...
    try:
        ...
        a = e.messages
    assert_string_arrays_equal(testcase.output, a, 'Invalid parser output ({}, line {})'.format(testcase.file, testcase.line))
